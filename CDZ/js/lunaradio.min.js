        ...
        function He() {
            switch (G) {
                ...
                case "stream-icy-meta":
                    i = ft(), a = Oe + "xstream-icy-meta.php", e.ajax({
                        dataType: "text",
                        url: a,
                        method: "POST",
                        crossDomain: !0,
                ...
                default:
                    switch (W) {
                        ...
                        case "radiojar":
                            ! function() {
                                var t = "https://api-v2.streamafrica.net/icyv2?url=https://stream.zeno.fm/" + J + "/?rand="+ Math.random();
                                e.ajax({
                                    dataType: "text",
                                    method: "GET",
                                    crossDomain: !0,
...
case "radiozeno":
! function() {
var t = "https://api-v2.streamafrica.net/icyv2?url=https://stream.zeno.fm/" + zn ;
e.ajax({
dataType: "text",
method: "GET",
crossDomain: !0,
...
try {
var t = JSON.parse(e);
Ke(t.artist + " - " + t.song, t.title, t.thumb)
} catch (e) {
Ke("", "")
}
},
