!function(e, t) {
    ...
    b.extend = b.fn.extend = function() {
        ...
        s--); s < l; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    n = a[t],
                    a !== (i = e[t]) && (c && i && (b.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1,
                    r = n && Array.isArray(n) ? n : []) : r = n && b.isPlainObject(n) ? n : {},
                    a[t] = b.extend(c, r, i)) : void 0 !== i && (a[t] = i));
        return a
    }
    ,
    b.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (C(Object(e)) ? b.merge(n, "string" == typeof e ? [e] : e) : s.call(n, e)),
            n
        },
    ...
    var S = function(e) {
        var t, n, i, o, r, a, s, l, c, u, d, f, p, h, m, g, v, y, x, b = "sizzle" + 1 * new Date, w = e.document, C = 0, S = 0, T = ae(), _ = ae(), E = ae(), k = function(e, t) {
            return e === t && (d = !0),
            0
        }, D = {}.hasOwnProperty, A = [], N = A.pop, B = A.push, O = A.push, j = A.slice, L = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, M = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", I = "[\\x20\\t\\r\\n\\f]", P = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", R = "\\[" + I + "*(" + P + ")(?:" + I + "*([*^$|!~]?=)" + I + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + P + "))|)" + I + "*\\]", q = ":(" + P + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", H = new RegExp(I + "+","g"), W = new RegExp("^" + I + "+|((?:^|[^\\\\])(?:\\\\.)*)" + I + "+$","g"), $ = new RegExp("^" + I + "*," + I + "*"), F = new RegExp("^" + I + "*([>+~]|" + I + ")" + I + "*"), z = new RegExp("=" + I + "*([^\\]'\"]*?)" + I + "*\\]","g"), U = new RegExp(q), X = new RegExp("^" + P + "$"), V = {
            ID: new RegExp("^#(" + P + ")"),
            CLASS: new RegExp("^\\.(" + P + ")"),
            TAG: new RegExp("^(" + P + "|[*])"),
            ATTR: new RegExp("^" + R),
        ...
        }, Y = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, G = /^[^{]+\{\s*\[native \w/, J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, K = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + I + "?|(" + I + ")|.)","ig"), ee = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        try {
            O.apply(A = j.call(w.childNodes), w.childNodes),
        ...
        function re(e, t, i, o) {
            var r, s, c, u, d, h, v, y = t && t.ownerDocument, C = t ? t.nodeType : 9;
            if (i = i || [],
        ...
        f = re.setDocument = function(e) {
            ...
            k = t ? function(e, t) {
                ...
                return i || (1 & (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e === p || e.ownerDocument === w && x(w, e) ? -1 : t === p || t.ownerDocument === w && x(w, t) ? 1 : u ? L(u, e) - L(u, t) : 0 : 4 & i ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return d = !0,
        ...
        (i = re.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    : function(t, n, l) {
                        var c, u, d, f, p, h, m = r !== a ? "nextSibling" : "previousSibling", g = t.parentNode, v = s && t.nodeName.toLowerCase(), y = !l && !s, x = !1;
                        if (g) {
                            if (r) {
                                for (; m; ) {
                                    for (f = t; f = f[m]; )
                            ...
                            a && y) {
                                for (x = (p = (c = (u = (d = (f = g)[b] || (f[b] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === C && c[1]) && c[2],
                                f = p && g.childNodes[p]; f = ++p && f && f[m] || (x = p = 0) || h.pop(); )
                                    if (1 === f.nodeType && ++x && f === t) {
                                        u[e] = [C, p, x];
                                        break
                                    }
                            } else if (y && (x = p = (c = (u = (d = (f = t)[b] || (f[b] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === C && c[1]),
                            !1 === x)
                                for (; (f = ++p && f && f[m] || (x = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++x || (y && ((u = (d = f[b] || (f[b] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [C, x]),
                                f !== t)); )
                                    ;
        ...
        function we(e, t, n, i, o, r) {
            ...
            o && !o[b] && (o = we(o, r)),
            se(function(r, a, s, l) {
                var c, u, d, f = [], p = [], h = a.length, m = r || function(e, t, n) {
                    for (var i = 0, o = t.length; i < o; i++)
                        re(e, t[i], n);
                    return n
                }(t || "*", s.nodeType ? [s] : s, []), g = !e || !r && t ? m : be(m, f, e, s, l), v = n ? o || (r ? e : h || i) ? [] : a : g;
                if (n && n(g, v, s, l),
                i)
                    for (c = be(v, p),
                    i(c, [], s, l),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (u = v.length; u--; )
                            (d = v[u]) && (c = o ? L(r, d) : f[u]) > -1 && (r[c] = !(a[c] = d))
                    }
                } else
                ...
                if (n = i.relative[e[l].type])
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[b]) {
                        ...
                        return we(l > 1 && xe(f), l > 1 && ve(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(W, "$1"), n, l < o && Ce(e.slice(l, o)), o < r && Ce(e = e.slice(o)), o < r && ve(e))
                    }
                    f.push(n)
                }
            return xe(f)
        ...
        function Se(e, t) {
            var n = t.length > 0
              ...
              , r = function(r, a, s, l, u) {
                var d, h, g, v = 0, y = "0", x = r && [], b = [], w = c, S = r || o && i.find.TAG("*", u), T = C += null == w ? 1 : Math.random() || .1, _ = S.length;
                for (u && (c = a === p || a || u); y !== _ && null != (d = S[y]); y++) {
                    if (o && d) {
                        for (h = 0,
                ...
                n && y !== v) {
                    ...
                    O.apply(l, b),
                    u && !r && b.length > 0 && v + t.length > 1 && re.uniqueSort(l)
                }
                return u && (C = T,
                c = w),
                x
        ...
        a = re.tokenize = function(e, t) {
            ...
            return t ? s.length : s ? re.error(e) : _(e, l).slice(0)
        }
        ,
        s = re.compile = function(e, t) {
            ...
            if (!r) {
                for (t || (t = a(e)),
                n = t.length; n--; )
                    (r = Ce(t[n]))[b] ? i.push(r) : o.push(r);
                (r = E(e, Se(o, i))).selector = e
            }
            return r
        }
        ,
        l = re.select = function(e, t, n, o) {
            ...
            1 === p.length) {
                ...
                !i.relative[u = c.type]); )
                    if ((d = i.find[u]) && (o = d(c.matches[0].replace(Z, ee), K.test(l[0].type) && me(t.parentNode) || t))) {
                        if (l.splice(r, 1),
                        !(e = o.length && ve(l)))
                            return O.apply(n, o),
                            n;
            ...
            return (f || s(e, p))(o, t, !m, n, !t || K.test(e) && me(t.parentNode) || t),
            n
        }
        ,
    ...
    var D = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
    function A(e, t, n) {
        return m(t) ? b.grep(e, function(e, i) {
    ...
    b.fn.extend({
        ...
        is: function(e) {
            return !!A(this, "string" == typeof e && E.test(e) ? b(e) : e || [], !1).length
        }
    });
    var N, B = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (b.fn.init = function(e, t, n) {
        ...
        if (n = n || N,
        "string" == typeof e) {
            if (!(o = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : B.exec(e)) || !o[1] && t)
                return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
            if (o[1]) {
                if (t = t instanceof b ? t[0] : t,
                b.merge(this, b.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : i, !0)),
                D.test(o[1]) && b.isPlainObject(t))
                    for (o in t)
        ...
        this.length = 1,
        this) : m(e) ? void 0 !== n.ready ? n.ready(e) : e(b) : b.makeArray(e, this)
    }
    ).prototype = b.fn,
    N = b(i);
    ...
    b.fn.extend({
        ...
        closest: function(e, t) {
            var n, i = 0, o = this.length, r = [], a = "string" != typeof e && b(e);
            if (!E.test(e))
                for (; i < o; i++)
    ...
    b.each({
        ...
        b.fn[e] = function(n, i) {
            ...
            this.length > 1 && (j[e] || b.uniqueSort(o),
            O.test(e) && o.reverse()),
            this.pushStack(o)
        }
    });
    ...
    b.extend({
                ...
                then: function(t, i, o) {
                    ...
                    function a(t, n, i, o) {
                        return function() {
                            var s = this
                              ...
                              , c = function() {
                                ...
                                if (!(t < r)) {
                                    ...
                                    m(c) ? o ? c.call(e, a(r, n, I, o), a(r, n, P, o)) : (r++,
                                    c.call(e, a(r, n, I, o), a(r, n, P, o), a(r, n, I, n.notifyWith))) : (i !== I && (s = void 0,
                                    l = [e]),
                                    (o || n.resolveWith)(s, l))
                                }
                            }
                              , u = o ? c : function() {
                                try {
                                    ...
                                    b.Deferred.exceptionHook && b.Deferred.exceptionHook(e, u.stackTrace),
                                    t + 1 >= r && (i !== P && (s = void 0,
                                    l = [e]),
                                    n.rejectWith(s, l))
                                }
                            ...
                            ;
                            t ? u() : (b.Deferred.getStackHook && (u.stackTrace = b.Deferred.getStackHook()),
                            e.setTimeout(u))
                        }
                    }
                    return b.Deferred(function(e) {
                        n[0][3].add(a(0, e, m(o) ? o : I, e.notifyWith)),
                        n[1][3].add(a(0, e, m(t) ? t : I)),
                        n[2][3].add(a(0, e, m(i) ? i : P))
                    }).promise()
                },
                promise: function(e) {
        ...
        when: function(e) {
            ...
            "pending" === a.state() || m(o[n] && o[n].then)))
                return a.then();
            for (; n--; )
                R(o[n], s(n), a.reject);
            return a.promise()
    ...
    b.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --b.readyWait > 0 || H.resolveWith(i, [b]))
        }
    }),
    b.ready.then = H.then,
    "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(b.ready) : (i.addEventListener("DOMContentLoaded", W),
    ...
    b.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                i = Q.get(e, t),
                n && (!i || Array.isArray(n) ? i = Q.access(e, t, b.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    b.fn.extend({
        ...
        promise: function(e, t) {
            var n, i = 1, o = b.Deferred(), r = this, a = this.length, s = function() {
                --i || o.resolveWith(r, [r])
            };
    ...
    function re(e, t, n, i) {
        ...
        , l = s(), c = n && n[3] || (b.cssNumber[t] ? "" : "px"), u = (b.cssNumber[t] || "px" !== c && +l) && te.exec(b.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; a--; )
    ...
    function le(e, t) {
        for (var n, i, o = [], r = 0, a = e.length; r < a; r++)
            ...
            o[r] || (i.style.display = "")),
            "" === i.style.display && ie(i) && (o[r] = se(i))) : "none" !== n && (o[r] = "none",
            Q.set(i, "display", n)));
        for (r = 0; r < a; r++)
    ...
    function ge(e, t, n, i, o) {
        for (var r, a, s, l, c, u, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
            if ((r = e[p]) || 0 === r)
                if ("object" === x(r))
                    b.merge(f, r.nodeType ? [r] : r);
                else if (me.test(r)) {
                    for (a = a || d.appendChild(t.createElement("div")),
                    s = (ue.exec(r) || ["", ""])[1].toLowerCase(),
                    l = fe[s] || fe._default,
                    a.innerHTML = l[1] + b.htmlPrefilter(r) + l[2],
                    u = l[0]; u--; )
                        a = a.lastChild;
        ...
        p = 0; r = f[p++]; )
            if (i && b.inArray(r, i) > -1)
                o && o.push(r);
            else if (c = b.contains(r.ownerDocument, r),
            a = pe(d.appendChild(r), "script"),
            c && he(a),
            n)
                for (u = 0; r = a[u++]; )
    ...
    b.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, a, s, l, c, u, d, f, p, h, m, g = Q.get(e);
            if (g)
        ...
        remove: function(e, t, n, i, o) {
            var r, a, s, l, c, u, d, f, p, h, m, g = Q.hasData(e) && Q.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(M) || [""]).length; c--; )
                    if (p = m = (s = be.exec(t[c]) || [])[1],
                    h = (s[2] || "").split(".").sort(),
                    p) {
                        for (d = b.event.special[p] || {},
                        ...
                        a && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, g.handle) || b.removeEvent(e, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
                            b.event.remove(e, p + t[c], n, i, !0);
                b.isEmptyObject(l) && Q.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, i, o, r, a, s = b.event.fix(e), l = new Array(arguments.length), c = (Q.get(this, "events") || {})[s.type] || [], u = b.event.special[s.type] || {};
            for (l[0] = s,
            t = 1; t < arguments.length; t++)
                l[t] = arguments[t];
            if (s.delegateTarget = this,
            !u.preDispatch || !1 !== u.preDispatch.call(this, s)) {
                for (a = b.event.handlers.call(this, s, c),
                t = 0; (o = a[t++]) && !s.isPropagationStopped(); )
                    ...
                    n = 0; (r = o.handlers[n++]) && !s.isImmediatePropagationStopped(); )
                        ...
                        s.data = r.data,
                        void 0 !== (i = ((b.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (s.result = i) && (s.preventDefault(),
                        s.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        ...
                        a = {},
                        n = 0; n < l; n++)
                            void 0 === a[o = (i = t[n]).selector + " "] && (a[o] = i.needsContext ? b(o, this).index(c) > -1 : b.find(o, this, null, [c]).length),
                            a[o] && r.push(i);
                        r.length && s.push({
                            elem: c,
                            handlers: r
    ...
    b.each({
        ...
        b.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return i && (i === this || b.contains(this, i)) || (e.type = o.origType,
    ...
    function Le(e, t, n, i) {
        ...
        if (v || f > 1 && "string" == typeof g && !h.checkClone && ke.test(g))
            return e.each(function(o) {
                var r = e.eq(o);
                v && (t[0] = g.call(this, o, r.html())),
                Le(r, t, n, i)
            });
        if (f && (r = (o = ge(t, e[0].ownerDocument, !1, e, i)).firstChild,
        1 === o.childNodes.length && (o = r),
        r || i)) {
            for (l = (s = b.map(pe(o, "script"), Ne)).length; d < f; d++)
                c = o,
                d !== p && (c = b.clone(c, !0, !0),
                l && b.merge(s, pe(c, "script"))),
                n.call(e[d], c, d);
            if (l)
                ...
                d = 0; d < l; d++)
                    c = s[d],
                    de.test(c.type || "") && !Q.access(c, "globalEval") && b.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? b._evalUrl && b._evalUrl(c.src) : y(c.textContent.replace(De, ""), u, c))
        }
        return e
    }
    function Me(e, t, n) {
        for (var i, o = t ? b.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
            n || 1 !== i.nodeType || b.cleanData(pe(i)),
            i.parentNode && (n && b.contains(i.ownerDocument, i) && he(pe(i, "script")),
    ...
    b.extend({
        ...
        clone: function(e, t, n) {
            var i, o, r, a, s = e.cloneNode(!0), l = b.contains(e.ownerDocument, e);
            if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e)))
                for (a = pe(s),
                i = 0,
                o = (r = pe(e)).length; i < o; i++)
                    je(r[i], a[i]);
            if (t)
                if (n)
                    for (r = r || pe(e),
                    ...
                    Oe(e, s);
            return (a = pe(s, "script")).length > 0 && he(a, !l && pe(e, "script")),
            s
        },
    ...
    b.fn.extend({
        ...
        html: function(e) {
            return $(this, function(e) {
                ...
                if ("string" == typeof e && !Ee.test(e) && !fe[(ue.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < i; n++)
                            1 === (t = this[n] || {}).nodeType && (b.cleanData(pe(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return Le(this, arguments, function(t) {
                ...
                b.inArray(this, e) < 0 && (b.cleanData(pe(this)),
    ...
    function qe(e, t, n) {
        ...
        return (n = n || Pe(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || b.contains(e.ownerDocument, e) || (a = b.style(e, t)),
        !h.pixelBoxStyles() && Ie.test(a) && Re.test(t) && (i = s.width,
        o = s.minWidth,
        r = s.maxWidth,
    ...
    function Qe(e, t, n, i, o, r) {
        ...
        if (n === (i ? "border" : "content"))
            return 0;
        for (; a < 4; a += 2)
            "margin" === n && (l += b.css(e, n + ne[a], !0, o)),
            i ? ("content" === n && (l -= b.css(e, "padding" + ne[a], !0, o)),
            "margin" !== n && (l -= b.css(e, "border" + ne[a] + "Width", !0, o))) : (l += b.css(e, "padding" + ne[a], !0, o),
            "padding" !== n ? l += b.css(e, "border" + ne[a] + "Width", !0, o) : s += b.css(e, "border" + ne[a] + "Width", !0, o));
        return !i && r >= 0 && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - r - l - s - .5))),
        l
    }
    function Ge(e, t, n) {
        var i = Pe(e)
        ...
        return a = a && (h.boxSizingReliable() || o === e.style[t]),
        ("auto" === o || !parseFloat(o) && "inline" === b.css(e, "display", !1, i)) && (o = e["offset" + t[0].toUpperCase() + t.slice(1)],
        a = !0),
        (o = parseFloat(o) || 0) + Qe(e, t, n || (r ? "border" : "content"), a, i, o) + "px"
    }
    ...
    b.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, a, s = X(t), l = $e.test(t), c = e.style;
                if (l || (t = Ve(s)),
                ...
                r = "number"),
                null != n && n == n && ("number" === r && (n += o && o[3] || (b.cssNumber[s] ? "" : "px")),
        ...
        css: function(e, t, n, i) {
            var o, r, a, s = X(t);
            return $e.test(t) || (t = Ve(s)),
            (a = b.cssHooks[t] || b.cssHooks[s]) && "get"in a && (o = a.get(e, !0, n)),
            void 0 === o && (o = qe(e, t, i)),
    ...
    b.each(["height", "width"], function(e, t) {
        b.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !We.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, t, i) : oe(e, Fe, function() {
                        return Ge(e, t, i)
                    })
            },
            set: function(e, n, i) {
                var o, r = Pe(e), a = "border-box" === b.css(e, "boxSizing", !1, r), s = i && Qe(e, t, i, a, r);
                return a && h.scrollboxSize() === r.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - Qe(e, t, "border", !1, r) - .5)),
    ...
    b.cssHooks.marginLeft = He(h.reliableMarginLeft, function(e, t) {
        if (t)
    ...
    function nt() {
        Ze && (!1 === i.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(nt) : e.setTimeout(nt, b.fx.interval),
        b.fx.tick())
    }
    function it() {
    ...
    function at(e, t, n) {
        var i, o, r = 0, a = at.prefilters.length, s = b.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var t = Ke || it(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++)
                c.tweens[r].run(i);
        ...
        for (function(e, t) {
            ...
            if (i = at.prefilters[r].call(c, e, u, c.opts))
                return m(i.stop) && (b._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
                i;
        return b.map(u, rt, c),
    ...
    b.Animation = b.extend(at, {
        ...
        prefilters: [function(e, t, n) {
            var i, o, r, a, s, l, c, u, d = "width"in t || "height"in t, f = this, p = {}, h = e.style, m = e.nodeType && ie(e), g = Q.get(e, "fxshow");
            ...
            if ((l = !b.isEmptyObject(t)) || !b.isEmptyObject(p))
                ...
                "none" === (u = b.css(e, "display")) && (c ? u = c : (le([e], !0),
                c = e.style.display || c,
                u = b.css(e, "display"),
                le([e]))),
                ("inline" === u || "inline-block" === u && null != c) && "none" === b.css(e, "float") && (l || (f.done(function() {
                    h.display = c
                }),
                null == c && (u = h.display,
                c = "none" === u ? "" : u)),
    ...
    b.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = Q.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = b.timers, a = i ? i.length : 0;
                for (n.finish = !0,
                b.queue(this, e, []),
    ...
    b.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === e.getAttribute ? b.prop(e, t, n) : (1 === r && b.isXMLDoc(e) || (o = b.attrHooks[t.toLowerCase()] || (b.expr.match.bool.test(t) ? st : void 0)),
    ...
    b.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, o = e.options, r = b.makeArray(t), a = o.length; a--; )
                        ((i = o[a]).selected = b.inArray(b.valHooks.option.get(i), r) > -1) && (n = !0);
    ...
    b.extend(b.event, {
        trigger: function(t, n, o, r) {
            var a, s, l, c, u, f, p, h, v = [o || i], y = d.call(t, "type") ? t.type : t, x = d.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = h = l = o = o || i,
            3 !== o.nodeType && 8 !== o.nodeType && !mt.test(y + b.event.triggered) && (y.indexOf(".") > -1 && (y = (x = y.split(".")).shift(),
            x.sort()),
            u = y.indexOf(":") < 0 && "on" + y,
            ...
            r || !p.trigger || !1 !== p.trigger.apply(o, n))) {
                if (!r && !p.noBubble && !g(o)) {
                    ...
                    mt.test(c + y) || (s = s.parentNode); s; s = s.parentNode)
                        v.push(s),
                        l = s;
                ...
                for (a = 0; (s = v[a++]) && !t.isPropagationStopped(); )
                    ...
                    (f = (Q.get(s, "events") || {})[t.type] && Q.get(s, "handle")) && f.apply(s, n),
                    (f = u && s[u]) && f.apply && V(s) && (t.result = f.apply(s, n),
                    !1 === t.result && t.preventDefault());
                return t.type = y,
                r || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), n) || !V(o) || u && m(o[y]) && !g(o) && ((l = o[u]) && (o[u] = null),
                b.event.triggered = y,
    ...
    function Tt(e, t, n, i) {
        ...
        if (Array.isArray(t))
            b.each(t, function(t, o) {
                n || bt.test(e) ? i(e, o) : Tt(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, i)
            });
    ...
    b.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !b(this).is(":disabled") && St.test(this.nodeName) && !Ct.test(e) && (this.checked || !ce.test(e))
            }).map(function(e, t) {
                var n = b(this).val();
    ...
    b.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var o, r, a, s, l, c, u, d, f, p, h = b.ajaxSetup({}, n), m = h.context || h, g = h.context && (m.nodeType || m.jquery) ? b(m) : b.event, v = b.Deferred(), y = b.Callbacks("once memory"), x = h.statusCode || {}, w = {}, C = {}, S = "canceled", T = {
                readyState: 0,
            ...
            if (v.promise(T),
            h.url = ((t || h.url || vt.href) + "").replace(Nt, vt.protocol + "//"),
            ...
            null == h.crossDomain) {
                ...
                try {
                    c.href = h.url,
                    c.href = c.href,
                    h.crossDomain = Lt.protocol + "//" + Lt.host != c.protocol + "//" + c.host
                } catch (e) {
                    h.crossDomain = !0
                }
            }
            ...
            u)
                return T;
            for (f in (d = b.event && h.global) && 0 == b.active++ && b.event.trigger("ajaxStart"),
            ...
            h.data && (h.processData || "string" == typeof h.data) && (r += (xt.test(r) ? "&" : "?") + h.data,
            delete h.data),
            !1 === h.cache && (r = r.replace(kt, "$1"),
            p = (xt.test(r) ? "&" : "?") + "_=" + yt++ + p),
            h.url = r + p),
            h.ifModified && (b.lastModified[r] && T.setRequestHeader("If-Modified-Since", b.lastModified[r]),
            ...
            T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + jt + "; q=0.01" : "") : h.accepts["*"]),
            h.headers)
            ...
            function _(t, n, i, s) {
                ...
                c ? (h.ifModified && ((C = T.getResponseHeader("Last-Modified")) && (b.lastModified[r] = C),
                (C = T.getResponseHeader("etag")) && (b.etag[r] = C)),
                204 === t || "HEAD" === h.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = w.state,
                f = w.data,
                c = !(p = w.error))) : (p = S,
                !t && S || (S = "error",
                t < 0 && (t = 0))),
                T.status = t,
                T.statusText = (n || S) + "",
                c ? v.resolveWith(m, [f, S, T]) : v.rejectWith(m, [T, S, p]),
                T.statusCode(x),
                x = void 0,
                d && g.trigger(c ? "ajaxSuccess" : "ajaxError", [T, h, c ? f : p]),
                y.fireWith(m, [T, S]),
                ...
                send: function(o, r) {
                    ...
                    n = function(e) {
                        return function() {
                            ...
                            "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(Rt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                binary: s.response
                            } : {
                                text: s.responseText
    ...
    b.ajaxPrefilter("json jsonp", function(t, n, i) {
        ...
        if (s || "jsonp" === t.dataTypes[0])
            ...
            s ? t[s] = t[s].replace(Wt, "$1" + o) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
            t.converters["script json"] = function() {
                return a || b.error(o + " was not called"),
                a[0]
            }
            ,
            t.dataTypes[0] = "json",
    ...
    b.parseHTML = function(e, t, n) {
        ...
        a = !n && [],
        (r = D.exec(e)) ? [t.createElement(r[1])] : (r = ge([e], t, a),
    ...
    b.fn.load = function(e, t, n) {
        ...
        a.length > 0 && b.ajax({
            ...
            r = arguments,
            a.html(i ? b("<div>").append(b.parseHTML(e)).find(i) : e)
    ...
    b.offset = {
        setOffset: function(e, t, n) {
            var i, o, r, a, s, l, c = b.css(e, "position"), u = b(e), d = {};
    ...
    b.each(["top", "left"], function(e, t) {
        b.cssHooks[t] = He(h.pixelPosition, function(e, n) {
            if (n)
                return n = qe(e, t),
        ...
        b.each({
            ...
            b.fn[i] = function(o, r) {
                ...
                return $(this, function(t, n, o) {
                    ...
                    Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === o ? b.css(t, n, s) : b.style(t, n, o, s)
                }, t, a ? o : void 0, a)
            }
        })
    }),
...
function(e) {
    ...
    ;
    var t, n = "rangeslider", i = 0, o = ((t = document.createElement("input")).setAttribute("type", "range"),
    "text" !== t.type), r = {
        polyfill: !0,
    ...
    function d(t, s) {
        ...
        this.DIMENSION = a.orientation[this.orientation].dimension,
        this.DIRECTION = a.orientation[this.orientation].direction,
        this.DIRECTION_STYLE = a.orientation[this.orientation].directionStyle,
        this.COORDINATE = a.orientation[this.orientation].coordinate,
        this.polyfill && o)
            return !1;
        this.identifier = "js-" + n + "-" + i++,
        ...
        function() {
            if (!l.debouncing) {
                ...
                l.lastReturnVal = l.apply(window, e),
                l.debouncing = !0
            }
            return clearTimeout(l.debounceTimeout),
            l.debounceTimeout = setTimeout(function() {
                l.debouncing = !1
            }, c),
            l.lastReturnVal
        }
        ...
        this.$element.on("change." + this.identifier, function(e, t) {
            if (!t || t.origin !== u.identifier) {
                var n = e.target.value
                  , i = u.getPositionFromValue(n);
                u.setPosition(i)
            }
        })
    }
    ...
    d.prototype.update = function(e, t) {
        (e = e || !1) && (this.min = c(this.$element[0].getAttribute("min"), 0),
        this.max = c(this.$element[0].getAttribute("max"), 100),
        this.value = c(this.$element[0].value, Math.round(this.min + (this.max - this.min) / 2)),
        this.step = c(this.$element[0].getAttribute("step"), 1)),
        this.handleDimension = l(this.$handle[0], "offset" + u(this.DIMENSION)),
        this.rangeDimension = l(this.$range[0], "offset" + u(this.DIMENSION)),
    ...
    ,
    d.prototype.handleDown = function(e) {
        if (e.preventDefault(),
        !(e.button && 0 !== e.button || (this.$document.on(this.moveEvent, this.handleMove),
    ...
    ,
    d.prototype.handleMove = function(e) {
        e.preventDefault();
        var t = this.getRelativePosition(e)
    ...
    ,
    d.prototype.handleEnd = function(e) {
        e.preventDefault(),
    ...
    ,
    d.prototype.cap = function(e, t, n) {
    ...
    ,
    d.prototype.getPositionFromNode = function(e) {
        for (var t = 0; null !== e; )
            t += e.offsetLeft,
            e = e.offsetParent;
        return t
    ...
    ,
    d.prototype.getRelativePosition = function(e) {
        var t = u(this.COORDINATE)
          , n = this.$range[0].getBoundingClientRect()[this.DIRECTION]
          , i = 0;
        return void 0 !== e.originalEvent["client" + t] ? i = e.originalEvent["client" + t] : e.originalEvent.touches && e.originalEvent.touches[0] && void 0 !== e.originalEvent.touches[0]["client" + t] ? i = e.originalEvent.touches[0]["client" + t] : e.currentPoint && void 0 !== e.currentPoint[this.COORDINATE] && (i = e.currentPoint[this.COORDINATE]),
        i - n
    }
    ,
    d.prototype.getPositionFromValue = function(e) {
        var t;
        return t = (e - this.min) / (this.max - this.min),
        Number.isNaN(t) ? 0 : t * this.maxHandlePos
    }
    ,
    d.prototype.getValueFromPosition = function(e) {
        var t, n;
        return t = e / (this.maxHandlePos || 1),
    ...
    d.prototype.destroy = function() {
        ...
        this.$element.off("." + this.identifier).removeAttr("style").removeData("plugin_" + n),
    ...
    e.fn[n] = function(t) {
        ...
        return this.each(function() {
            var o = e(this)
              , r = o.data("plugin_" + n);
            r || o.data("plugin_" + n, r = new d(this,t)),
...
function(e) {
    ...
    var t, n, i, o, r, a, s, l, c, u, d, f, p, h, m, g, v, y, x, b, w, C, S, T, _, E, k, D, A, N, B, O, j, L, M, I, P, R, q, H, W, $, F, z, U, X, V, Y, Q, G, J, K, Z, ee, te, ne, ie, oe;
    ne = "function" == typeof define && define.amd,
    ie = "undefined" != typeof module && module.exports,
    oe = "https:" == document.location.protocol ? "https:" : "http:",
    ne || (ie ? require("jquery-mousewheel")(e) : e.event.special.mousewheel || e("head").append(decodeURI("%3Cscript src=" + oe + "//cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.13/jquery.mousewheel.min.js%3E%3C/script%3E"))),
    n = "mCustomScrollbar",
    i = {
        setTop: 0,
        setLeft: 0,
        ...
        init: function(t) {
            ...
            e(n).each(function() {
                ...
                if (!n.data("mCS")) {
                    ...
                    e("#mCSB_" + i.idx + "_container img:not(." + l[2] + ")").addClass(l[2]),
                    c.update.call(null, n)
                }
            })
        },
        update: function(t, n) {
            ...
            return e(i).each(function() {
                ...
                if (t.data("mCS")) {
                    ...
                    t.hasClass(l[3]) && t.removeClass(l[3]),
                    t.hasClass(l[4]) && t.removeClass(l[4]),
                    a.css("max-height", "none"),
                    a.height() !== t.height() && a.css("max-height", t.height()),
                    v.call(this),
                    "y" === o.axis || o.advanced.autoExpandHorizontalScroll || r.css("width", g(r)),
                    i.overflowed = C.call(this),
                    E.call(this),
                    o.autoDraggerLength && x.call(this),
                    b.call(this),
                    T.call(this);
                    var c = [Math.abs(r[0].offsetTop), Math.abs(r[0].offsetLeft)];
                    "x" !== o.axis && (i.overflowed[0] ? s[0].height() > s[0].parent().height() ? S.call(this) : (X(t, c[0].toString(), {
                        dir: "y",
                        dur: 0,
                        overwrite: "none"
                    }),
                    i.contentReset.y = null) : (S.call(this),
                    "y" === o.axis ? _.call(this) : "yx" === o.axis && i.overflowed[1] && X(t, c[1].toString(), {
                        dir: "x",
                        dur: 0,
                        overwrite: "none"
                    }))),
                    "y" !== o.axis && (i.overflowed[1] ? s[1].width() > s[1].parent().width() ? S.call(this) : (X(t, c[1].toString(), {
                        dir: "x",
                        dur: 0,
                        overwrite: "none"
                    }),
                    i.contentReset.x = null) : (S.call(this),
                    "x" === o.axis ? _.call(this) : "yx" === o.axis && i.overflowed[0] && X(t, c[0].toString(), {
                        dir: "y",
                        dur: 0,
                        overwrite: "none"
                    }))),
            ...
            if (void 0 !== t && null != t) {
                ...
                return e(i).each(function() {
                    ...
                    if (i.data("mCS")) {
                        ...
                        s.moveDragger && (l[0] *= o.scrollRatio.y,
                        l[1] *= o.scrollRatio.x),
                        s.dur = te() ? 0 : c,
                        setTimeout(function() {
                            null !== l[0] && void 0 !== l[0] && "x" !== r.axis && o.overflowed[0] && (s.dir = "y",
                            s.overwrite = "all",
                            X(i, l[0].toString(), s)),
                            null !== l[1] && void 0 !== l[1] && "y" !== r.axis && o.overflowed[1] && (s.dir = "x",
                            s.overwrite = "none",
                            X(i, l[1].toString(), s))
                        }, s.timeout)
                    }
        ...
        destroy: function() {
            ...
            return e(t).each(function() {
                ...
                if (i.data("mCS")) {
                    ...
                    G(this, "mcs"),
                    c.remove(),
                    s.find("img." + l[2]).removeClass(l[2]),
                    a.replaceWith(s.contents()),
                    i.removeClass(n + " _mCS_" + o.idx + " " + l[6] + " " + l[7] + " " + l[5] + " " + l[3]).addClass(l[4])
                }
            })
        }
    },
    ...
    m = function() {
        var t = e(this)
          ...
          , u = "yx" === o.axis ? "<div id='mCSB_" + i.idx + "_container_wrapper' class='mCSB_container_wrapper' />" : ""
          , d = o.autoHideScrollbar ? " " + l[6] : ""
          , f = "x" !== o.axis && "rtl" === i.langDir ? " " + l[7] : "";
        o.setWidth && t.css("width", o.setWidth),
        o.setHeight && t.css("height", o.setHeight),
        o.setLeft = "y" !== o.axis && "rtl" === i.langDir ? "989999px" : o.setLeft,
        t.addClass(n + " _mCS_" + i.idx + d + f).wrapInner("<div id='mCSB_" + i.idx + "' class='mCustomScrollBox mCS-" + o.theme + " " + s + "'><div id='mCSB_" + i.idx + "_container' class='mCSB_container' style='position:relative; top:" + o.setTop + "; left:" + o.setLeft + ";' dir='" + i.langDir + "' /></div>");
        var p = e("#mCSB_" + i.idx)
          , h = e("#mCSB_" + i.idx + "_container");
        "y" === o.axis || o.advanced.autoExpandHorizontalScroll || h.css("width", g(h)),
        "outside" === o.scrollbarPosition ? ("static" === t.css("position") && t.css("position", "relative"),
        t.css("overflow", "visible"),
        p.addClass("mCSB_outside").after(c)) : (p.addClass("mCSB_inside").append(c),
        h.wrap(u)),
        y.call(this);
    ...
    y = function() {
        var t = e(this)
          ...
          , r = Z(i.scrollButtons.tabindex) ? "tabindex='" + i.scrollButtons.tabindex + "'" : ""
    ...
    w = function(e, t, n) {
        ...
        "active" === t ? (e.toggleClass(l[0] + " " + i),
        o.toggleClass(l[1]),
        e[0]._draggable = e[0]._draggable ? 0 : 1) : e[0]._draggable || ("hide" === t ? (e.removeClass(l[0]),
        o.removeClass(l[1])) : (e.addClass(l[0]),
        o.addClass(l[1])))
    }
    ,
    C = function() {
    ...
    S = function() {
        ...
        if (U(t),
        ("x" !== i.axis && !n.overflowed[0] || "y" === i.axis && n.overflowed[0]) && (a[0].add(r).css("top", 0),
        X(t, "_resetY")),
        "y" !== i.axis && !n.overflowed[1] || "x" === i.axis && n.overflowed[1]) {
            var s = dx = 0;
            "rtl" === n.langDir && (s = o.width() - r.outerWidth(!1),
            dx = Math.abs(s / n.scrollRatio.x)),
            r.css("left", s),
            a[1].css("left", dx),
            X(t, "_resetX")
        }
    ...
    T = function() {
        ...
        if (!n.bindEvents) {
            var o;
            if (D.call(this),
            i.contentTouchScroll && A.call(this),
            N.call(this),
            i.mouseWheel.enable)
                !function n() {
                    o = setTimeout(function() {
                        e.event.special.mousewheel ? (clearTimeout(o),
                        B.call(t[0])) : n()
                    }, 100)
                }();
            I.call(this),
    ...
    _ = function() {
        var t = e(this)
          ...
          , a = e("#mCSB_" + n.idx + ",#mCSB_" + n.idx + "_container,#mCSB_" + n.idx + "_container_wrapper," + r + " ." + l[12] + ",#mCSB_" + n.idx + "_dragger_vertical,#mCSB_" + n.idx + "_dragger_horizontal," + r + ">a")
          , s = e("#mCSB_" + n.idx + "_container");
        i.advanced.releaseDraggableSelectors && a.add(e(i.advanced.releaseDraggableSelectors)),
        i.advanced.extraDraggableSelectors && a.add(e(i.advanced.extraDraggableSelectors)),
        n.bindEvents && (e(document).add(e(!j() || top.document)).unbind("." + o),
        a.each(function() {
            e(this).unbind("." + o)
        }),
    ...
    E = function(t) {
        var n = e(this)
          ...
          , a = r.length ? r : e("#mCSB_" + i.idx + "_container")
          , s = [e("#mCSB_" + i.idx + "_scrollbar_vertical"), e("#mCSB_" + i.idx + "_scrollbar_horizontal")]
          , c = [s[0].find(".mCSB_dragger"), s[1].find(".mCSB_dragger")];
        "x" !== o.axis && (i.overflowed[0] && !t ? (s[0].add(c[0]).add(s[0].children("a")).css("display", "block"),
        a.removeClass(l[8] + " " + l[10])) : (o.alwaysShowScrollbar ? (2 !== o.alwaysShowScrollbar && c[0].css("display", "none"),
        a.removeClass(l[10])) : (s[0].css("display", "none"),
        a.addClass(l[10])),
        a.addClass(l[8]))),
        "y" !== o.axis && (i.overflowed[1] && !t ? (s[1].add(c[1]).add(s[1].children("a")).css("display", "block"),
        a.removeClass(l[9] + " " + l[11])) : (o.alwaysShowScrollbar ? (2 !== o.alwaysShowScrollbar && c[1].css("display", "none"),
        a.removeClass(l[11])) : (s[1].css("display", "none"),
        a.addClass(l[11])),
        a.addClass(l[9]))),
        i.overflowed[0] || i.overflowed[1] ? n.removeClass(l[5]) : n.addClass(l[5])
    }
    ,
    k = function(t) {
        var n = t.type
    ...
    ,
    D = function() {
        var t, n, i, o = e(this), r = o.data("mCS"), l = r.opt, c = "mCS_" + r.idx, u = ["mCSB_" + r.idx + "_dragger_vertical", "mCSB_" + r.idx + "_dragger_horizontal"], d = e("#mCSB_" + r.idx + "_container"), f = e("#" + u[0] + ",#" + u[1]), p = l.advanced.releaseDraggableSelectors ? f.add(e(l.advanced.releaseDraggableSelectors)) : f, h = l.advanced.extraDraggableSelectors ? e(!j() || top.document).add(e(l.advanced.extraDraggableSelectors)) : e(!j() || top.document);
        function m(e, n, i, a) {
            if (d[0].idleTimer = l.scrollInertia < 233 ? 250 : 0,
            t.attr("id") === u[1])
                var s = "x"
        ...
        f.bind("contextmenu." + c, function(e) {
            e.preventDefault()
        }).bind("mousedown." + c + " touchstart." + c + " pointerdown." + c + " MSPointerDown." + c, function(r) {
            ...
            J(r)) {
                ...
                u < p && u > 0 && f < h && f > 0 && (n = u,
                i = f),
                w(t, "active", l.autoExpandScrollbar)
            }
        ...
        }).add(p).bind("mouseup." + c + " touchend." + c + " pointerup." + c + " MSPointerUp." + c, function(e) {
            t && (w(t, "active", l.autoExpandScrollbar),
            t = null),
            s = !1,
    ...
    ,
    A = function() {
        var n, i, o, r, a, l, c, u, d, f, p, h, m, g, v = e(this), y = v.data("mCS"), x = y.opt, b = "mCS_" + y.idx, w = e("#mCSB_" + y.idx), C = e("#mCSB_" + y.idx + "_container"), S = [e("#mCSB_" + y.idx + "_dragger_vertical"), e("#mCSB_" + y.idx + "_dragger_horizontal")], T = [], _ = [], E = 0, D = "yx" === x.axis ? "none" : "all", A = [], N = C.find("iframe"), B = ["touchstart." + b + " pointerdown." + b + " MSPointerDown." + b, "touchmove." + b + " pointermove." + b + " MSPointerMove." + b, "touchend." + b + " pointerup." + b + " MSPointerUp." + b], O = void 0 !== document.body.style.touchAction && "" !== document.body.style.touchAction;
        function L(e) {
            if (!K(e) || s || k(e)[2])
                t = 0;
            else {
        ...
        function M(e) {
            if (K(e) && !s && !k(e)[2] && (x.documentTouchScroll || e.preventDefault(),
            e.stopImmediatePropagation(),
            (!g || m) && n)) {
                c = Y();
                var t = w.offset()
                ...
                if (T.push(r),
                _.push(a),
                A[2] = Math.abs(k(e)[0] - A[0]),
                A[3] = Math.abs(k(e)[1] - A[1]),
                y.overflowed[0])
                    var l = S[0].parent().height() - S[0].height()
                      , u = i - r > 0 && r - i > -l * y.scrollRatio.y && (2 * A[3] < A[2] || "yx" === x.axis);
                if (y.overflowed[1])
                    var d = S[1].parent().width() - S[1].width()
                      , f = o - a > 0 && a - o > -d * y.scrollRatio.x && (2 * A[2] < A[3] || "yx" === x.axis);
                u || f ? (O || e.preventDefault(),
                m = 1) : (g = 1,
                v.addClass("mCS_touch_action")),
                O && e.preventDefault(),
                p = "yx" === x.axis ? [i - r, o - a] : "x" === x.axis ? [null, o - a] : [i - r, null],
                C[0].idleTimer = 250,
                y.overflowed[0] && q(p[0], E, "mcsLinearOut", "y", "all", !0),
                y.overflowed[1] && q(p[1], E, "mcsLinearOut", "x", D, !0)
            }
        }
        function I(e) {
            if (!K(e) || s || k(e)[2])
        ...
        function P(e) {
            if (K(e) && !s && !k(e)[2]) {
                ...
                if (!(u - c > 30)) {
                    var v = (f = 1e3 / (u - l)) < 2.5
                      , b = v ? [T[T.length - 2], _[_.length - 2]] : [0, 0];
                    d = v ? [i - b[0], o - b[1]] : [i - r, o - a];
                    var S = [Math.abs(d[0]), Math.abs(d[1])];
                    f = v ? [Math.abs(d[0] / 4), Math.abs(d[1] / 4)] : [f, f];
                    var E = [Math.abs(C[0].offsetTop) - d[0] * R(S[0] / f[0], f[0]), Math.abs(C[0].offsetLeft) - d[1] * R(S[1] / f[1], f[1])];
                    p = "yx" === x.axis ? [E[0], E[1]] : "x" === x.axis ? [null, E[1]] : [E[0], null],
                    h = [4 * S[0] + x.scrollInertia, 4 * S[1] + x.scrollInertia];
                    var A = parseInt(x.contentTouchScroll) || 0;
                    p[0] = S[0] > A ? p[0] : 0,
                    p[1] = S[1] > A ? p[1] : 0,
                    y.overflowed[0] && q(p[0], h[0], "mcsEaseOut", "y", D, !1),
                    y.overflowed[1] && q(p[1], h[1], "mcsEaseOut", "x", D, !1)
                }
            }
        }
        function R(e, t) {
        ...
        C.bind(B[0], function(e) {
            L(e)
        }).bind(B[1], function(e) {
            M(e)
        }),
        w.bind(B[0], function(e) {
            I(e)
        }).bind(B[2], function(e) {
            P(e)
        }),
        N.length && N.each(function() {
            e(this).bind("load", function() {
                j(this) && e(this.contentDocument || this.contentWindow.document).bind(B[0], function(e) {
                    L(e),
                    I(e)
                }).bind(B[1], function(e) {
                    M(e)
    ...
    ,
    N = function() {
        var n, i = e(this), o = i.data("mCS"), r = o.opt, a = o.sequential, l = "mCS_" + o.idx, c = e("#mCSB_" + o.idx + "_container"), u = c.parent();
        function d(e, t, o) {
            a.type = o && n ? "stepped" : "stepless",
            a.scrollAmount = 10,
            W(i, e, t, "mcsLinearOut", o ? 60 : null)
        }
        c.bind("mousedown." + l, function(e) {
            ...
            if (!t && n && (window.getSelection ? window.getSelection().toString() : document.selection && "Control" != document.selection.type && document.selection.createRange().text)) {
                var i = c.offset()
                  , s = k(e)[0] - i.top + c[0].offsetTop
                  , l = k(e)[1] - i.left + c[0].offsetLeft;
                s > 0 && s < u.height() && l > 0 && l < u.width() ? a.step && d("off", null, "stepped") : ("x" !== r.axis && o.overflowed[0] && (s < 0 ? d("on", 38) : s > u.height() && d("on", 40)),
                "y" !== r.axis && o.overflowed[1] && (l < 0 ? d("on", 37) : l > u.width() && d("on", 39)))
            }
    ...
    B = function() {
        if (e(this).data("mCS")) {
            var t = e(this)
              ...
              , l = e("#mCSB_" + n.idx + "_container").find("iframe");
            l.length && l.each(function() {
                e(this).bind("load", function() {
                    j(this) && e(this.contentDocument || this.contentWindow.document).bind("mousewheel." + o, function(e, t) {
                        c(e, t)
                    })
                })
            }),
            r.bind("mousewheel." + o, function(e, t) {
                c(e, t)
            })
        }
        function c(o, l) {
            if (U(t),
            !M(t, o.target)) {
                var c = "auto" !== i.mouseWheel.deltaFactor ? parseInt(i.mouseWheel.deltaFactor) : a && o.deltaFactor < 100 ? 100 : o.deltaFactor || 100
                  , u = i.scrollInertia;
                if ("x" === i.axis || "x" === i.mouseWheel.axis)
                    var d = "x"
                      ...
                      , v = "y" === i.mouseWheel.axis ? o.deltaY || l : o.deltaX;
                else
                    var d = "y"
                      ...
                      , v = o.deltaY || l;
                "y" === d && !n.overflowed[0] || "x" === d && !n.overflowed[1] || ((i.mouseWheel.invert || o.webkitDirectionInvertedFromDevice) && (v = -v),
                i.mouseWheel.normalizeDelta && (v = v < 0 ? -1 : 1),
                (v > 0 && 0 !== m || v < 0 && m !== g || i.mouseWheel.preventDefault) && (o.stopImmediatePropagation(),
                o.preventDefault()),
                o.deltaFactor < 5 && !i.mouseWheel.normalizeDelta && (p = o.deltaFactor,
                u = 17),
                X(t, (h - v * p).toString(), {
                    dir: d,
                    dur: u
    ...
    ,
    I = function() {
        var t, n = e(this), i = n.data("mCS"), o = "mCS_" + i.idx, r = e("#mCSB_" + i.idx + "_container"), a = r.parent(), c = e(".mCSB_" + i.idx + "_scrollbar ." + l[12]);
        c.bind("mousedown." + o + " touchstart." + o + " pointerdown." + o + " MSPointerDown." + o, function(n) {
            ...
            if (t && (t = 0,
            e(o.target).hasClass(l[12]) || e(o.target).hasClass("mCSB_draggerRail"))) {
                U(n);
                var s = e(this)
                ...
                if (s.parent(".mCSB_scrollTools_horizontal").length > 0) {
                    ...
                    var u = "x"
                      ...
                      , f = Math.abs(r[0].offsetLeft) - d * (.9 * a.width())
                } else {
                    if (!i.overflowed[0])
                        return;
                    var u = "y"
                      , d = o.pageY > c.offset().top ? -1 : 1
                      , f = Math.abs(r[0].offsetTop) - d * (.9 * a.height())
                }
                X(n, f.toString(), {
                    dir: u,
                    scrollEasing: "mcsEaseInOut"
    ...
    P = function() {
        ...
        r.bind("focusin." + o, function(n) {
            ...
            o.is(i.advanced.autoScrollOnFocus) && (U(t),
            clearTimeout(t[0]._focusTimeout),
            t[0]._focusTimer = s ? 17 * s : 0,
            t[0]._focusTimeout = setTimeout(function() {
                var e = [ee(o)[0], ee(o)[1]]
                  , n = [r[0].offsetTop, r[0].offsetLeft]
                  , s = [n[0] + e[0] >= 0 && n[0] + e[0] < a.height() - o.outerHeight(!1), n[1] + e[1] >= 0 && n[0] + e[1] < a.width() - o.outerWidth(!1)]
                  , l = "yx" !== i.axis || s[0] || s[1] ? "all" : "none";
                "x" === i.axis || s[0] || X(t, e[0].toString(), {
                    dir: "y",
                    scrollEasing: "mcsEaseInOut",
                    overwrite: l,
                    dur: 0
                }),
                "y" === i.axis || s[1] || X(t, e[1].toString(), {
                    dir: "x",
                    scrollEasing: "mcsEaseInOut",
                    overwrite: l,
                    dur: 0
    ...
    H = function() {
        ...
        function f(r) {
            ...
            case "keydown":
            case "keyup":
                var a = r.keyCode ? r.keyCode : r.which
                  , u = "on";
                if ("x" !== i.axis && (38 === a || 40 === a) || "y" !== i.axis && (37 === a || 39 === a)) {
                    if ((38 === a || 40 === a) && !n.overflowed[0] || (37 === a || 39 === a) && !n.overflowed[1])
                        return;
                    "keyup" === r.type && (u = "off"),
                    e(document.activeElement).is(c) || (r.preventDefault(),
                    r.stopImmediatePropagation(),
                    h(u, a))
                } else if (33 === a || 34 === a) {
                    if ((n.overflowed[0] || n.overflowed[1]) && (r.preventDefault(),
                    r.stopImmediatePropagation()),
                    "keyup" === r.type) {
                        U(t);
                        var d = 34 === a ? -1 : 1;
                        if ("x" === i.axis || "yx" === i.axis && n.overflowed[1] && !n.overflowed[0])
                            var f = "x"
                              , p = Math.abs(s[0].offsetLeft) - d * (.9 * l.width());
                        else
                            var f = "y"
                              , p = Math.abs(s[0].offsetTop) - d * (.9 * l.height());
                        X(t, p.toString(), {
                            dir: f,
                            scrollEasing: "mcsEaseInOut"
                        })
                    }
                } else if ((35 === a || 36 === a) && !e(document.activeElement).is(c) && ((n.overflowed[0] || n.overflowed[1]) && (r.preventDefault(),
                r.stopImmediatePropagation()),
                "keyup" === r.type)) {
                    if ("x" === i.axis || "yx" === i.axis && n.overflowed[1] && !n.overflowed[0])
                        var f = "x"
                          , p = 35 === a ? Math.abs(l.width() - s.outerWidth(!1)) : 0;
                    else
                        var f = "y"
                          , p = 35 === a ? Math.abs(l.height() - s.outerHeight(!1)) : 0;
                    X(t, p.toString(), {
                        dir: f,
                        scrollEasing: "mcsEaseInOut"
                    })
            ...
            function h(e, r) {
                o.type = i.keyboard.scrollType,
                o.scrollAmount = i.keyboard.scrollAmount,
                "stepped" === o.type && n.tweenRunning || W(t, e, r)
            }
        }
        u.length && u.each(function() {
            e(this).bind("load", function() {
                j(this) && e(this.contentDocument || this.contentWindow.document).bind(d[0], function(e) {
                    f(e)
                })
            })
        }),
    ...
    W = function(t, n, i, o, r) {
        var a = t.data("mCS")
          ...
          , d = "stepped" === c.type
          , f = s.scrollInertia < 26 ? 26 : s.scrollInertia
          , p = s.scrollInertia < 1 ? 17 : s.scrollInertia;
        switch (n) {
        case "on":
            if (c.dir = [i === l[16] || i === l[15] || 39 === i || 37 === i ? "x" : "y", i === l[13] || i === l[15] || 38 === i || 37 === i ? -1 : 1],
            U(t),
            Z(i) && "stepped" === c.type)
                return;
            h(d);
    ...
    $ = function(t) {
        ...
        t instanceof Array ? i = t.length > 1 ? [t[0], t[1]] : "x" === n.axis ? [null, t[0]] : [t[0], null] : (i[0] = t.y ? t.y : t.x || "x" === n.axis ? null : t,
        i[1] = t.x ? t.x : t.y || "y" === n.axis ? null : t),
    ...
    F = function(t, n) {
        if (null != t && void 0 !== t) {
            ...
            case "number":
                ...
                if (-1 !== t.indexOf("+=")) {
                    var h = d + parseInt(t.split("+=")[1]);
                    return h >= 0 ? 0 : Math.abs(h)
                }
                if (-1 !== t.indexOf("px") && Z(t.split("px")[0]))
                    return Math.abs(t.split("px")[0]);
                if ("top" === t || "left" === t)
                    return 0;
                if ("bottom" === t)
                    return Math.abs(s.height() - a.outerHeight(!1));
                if ("right" === t)
                    return Math.abs(s.width() - a.outerWidth(!1));
                if ("first" === t || "last" === t) {
                    var p = a.find(":" + t);
                    return "x" === n ? ee(p)[1] : ee(p)[0]
                }
                return e(t).length ? "x" === n ? ee(e(t))[1] : ee(e(t))[0] : (a.css(f, t),
                void c.update.call(null, i[0]))
            }
        }
    }
    ,
    z = function(t) {
        ...
        if (t)
            ...
            void G(r[0], "autoUpdate");
        function a(e) {
            clearTimeout(r[0].autoUpdate),
            c.update.call(null, n[0], e)
        }
        !function t() {
            clearTimeout(r[0].autoUpdate),
            0 !== n.parents("html").length ? r[0].autoUpdate = setTimeout(function() {
                ...
                void a(3)) : o.advanced.updateOnContentResize && (i.poll.size.n = n[0].scrollHeight + n[0].scrollWidth + r[0].offsetHeight + n[0].offsetHeight + n[0].offsetWidth,
                i.poll.size.n !== i.poll.size.o) ? (i.poll.size.o = i.poll.size.n,
                void a(1)) : !o.advanced.updateOnImageLoad || "auto" === o.advanced.updateOnImageLoad && "y" === o.axis || (i.poll.img.n = r.find("img").length,
                i.poll.img.n === i.poll.img.o) ? void ((o.advanced.updateOnSelectorChange || o.advanced.updateOnContentResize || o.advanced.updateOnImageLoad) && t()) : (i.poll.img.o = i.poll.img.n,
    ...
    X = function(t, n, i) {
        var o = t.data("mCS")
          ...
          , u = c.parent()
          , d = r.callbacks.onTotalScrollOffset ? $.call(t, r.callbacks.onTotalScrollOffset) : [0, 0]
          , f = r.callbacks.onTotalScrollBackOffset ? $.call(t, r.callbacks.onTotalScrollBackOffset) : [0, 0];
        if (o.trigger = i.trigger,
        0 === u.scrollTop() && 0 === u.scrollLeft() || (e(".mCSB_" + o.idx + "_scrollbar").css("visibility", "visible"),
        u.scrollTop(0).scrollLeft(0)),
        "_resetY" !== n || o.contentReset.y || (T("onOverflowYNone") && r.callbacks.onOverflowYNone.call(t[0]),
        o.contentReset.y = 1),
        "_resetX" !== n || o.contentReset.x || (T("onOverflowXNone") && r.callbacks.onOverflowXNone.call(t[0]),
        o.contentReset.x = 1),
        "_resetY" !== n && "_resetX" !== n) {
            if (!o.contentReset.y && t[0].mcs || !o.overflowed[0] || (T("onOverflowY") && r.callbacks.onOverflowY.call(t[0]),
            o.contentReset.x = null),
            !o.contentReset.x && t[0].mcs || !o.overflowed[1] || (T("onOverflowX") && r.callbacks.onOverflowX.call(t[0]),
            o.contentReset.x = null),
            r.snapAmount) {
            ...
            case "x":
                var h = e("#mCSB_" + o.idx + "_dragger_horizontal")
                  , m = "left"
                  , g = c[0].offsetLeft
                  , v = [l.width() - c.outerWidth(!1), h.parent().width() - h.width()]
                  , y = [n, 0 === n ? 0 : n / o.scrollRatio.x]
                  , x = d[1]
                  , b = f[1]
                  , C = x > 0 ? x / o.scrollRatio.x : 0
            ...
            case "y":
                var h = e("#mCSB_" + o.idx + "_dragger_vertical")
                  , m = "top"
                  , g = c[0].offsetTop
                  , v = [l.height() - c.outerHeight(!1), h.parent().height() - h.height()]
                  , y = [n, 0 === n ? 0 : n / o.scrollRatio.y]
                  , x = d[0]
                  , b = f[0]
                  , C = x > 0 ? x / o.scrollRatio.y : 0
                  , S = b > 0 ? b / o.scrollRatio.y : 0
            }
            y[1] < 0 || 0 === y[0] && 0 === y[1] ? y = [0, 0] : y[1] >= v[1] ? y = [v[0], v[1]] : y[0] = -y[0],
            t[0].mcs || (_(),
            T("onInit") && r.callbacks.onInit.call(t[0])),
            clearTimeout(c[0].onCompleteTimeout),
            V(h[0], m, Math.round(y[1]), s[1], i.scrollEasing),
            !o.tweenRunning && (0 === g && y[0] >= 0 || g === v[0] && y[0] <= v[0]) || V(c[0], m, Math.round(y[0]), s[0], i.scrollEasing, i.overwrite, {
                onStart: function() {
                    i.callbacks && i.onStart && !o.tweenRunning && (T("onScrollStart") && (_(),
                    r.callbacks.onScrollStart.call(t[0])),
                    o.tweenRunning = !0,
                    w(h),
                    o.cbOffsets = [r.callbacks.alwaysTriggerOffsets || g >= v[0] + x, r.callbacks.alwaysTriggerOffsets || g <= -b])
                },
                onUpdate: function() {
                    i.callbacks && i.onUpdate && T("whileScrolling") && (_(),
                ...
                onComplete: function() {
                    if (i.callbacks && i.onComplete) {
                        ...
                        c[0].onCompleteTimeout = setTimeout(function() {
                            ...
                            T("onTotalScroll") && y[1] >= v[1] - C && o.cbOffsets[0] && (_(),
                            r.callbacks.onTotalScroll.call(t[0])),
                            T("onTotalScrollBack") && y[1] <= S && o.cbOffsets[1] && (_(),
        ...
        function T(e) {
            return o && r.callbacks[e] && "function" == typeof r.callbacks[e]
        }
        function _() {
    ...
    ,
    V = function(e, t, n, i, o, r, a) {
        e._mTween || (e._mTween = {
            top: {},
            left: {}
        });
        var s, l, a = a || {}, c = a.onStart || function() {}
        , u = a.onUpdate || function() {}
        , d = a.onComplete || function() {}
        , f = Y(), p = 0, h = e.offsetTop, m = e.style, g = e._mTween[t];
        ...
        function x() {
            i > 0 ? (g.currVal = function(e, t, n, i, o) {
                switch (o) {
                case "linear":
                case "mcsLinear":
                    return n * e / i + t;
            ...
            m[t] = Math.round(g.currVal) + "px") : m[t] = n + "px",
            u.call()
        }
        g.stop = 0,
        "none" !== r && null != g.id && (window.requestAnimationFrame ? window.cancelAnimationFrame(g.id) : clearTimeout(g.id),
        g.id = null),
        s = 1e3 / 60,
        g.time = p + s,
    ...
    Q = function() {
        ...
        for (var t = ["top", "left"], n = 0; n < t.length; n++) {
            var i = t[n];
            e._mTween[i].id && (window.requestAnimationFrame ? window.cancelAnimationFrame(e._mTween[i].id) : clearTimeout(e._mTween[i].id),
            e._mTween[i].id = null,
            e._mTween[i].stop = 1)
        }
    }
    ...
    e(window).bind("load", function() {
        e(".mCustomScrollbar")[n](),
        e.extend(e.expr[":"], {
            mcsInView: e.expr[":"].mcsInView || function(t) {
                var n, i, o = e(t), r = o.parents(".mCSB_container");
                if (r.length)
                    return n = r.parent(),
                    (i = [r[0].offsetTop, r[0].offsetLeft])[0] + ee(o)[0] >= 0 && i[0] + ee(o)[0] < n.height() - o.outerHeight(!1) && i[1] + ee(o)[1] >= 0 && i[1] + ee(o)[1] < n.width() - o.outerWidth(!1)
            }
            ,
            mcsInSight: e.expr[":"].mcsInSight || function(t, n, i) {
                var o, r, a, s, l = e(t), c = l.parents(".mCSB_container"), u = "exact" === i[3] ? [[1, 0], [1, 0]] : [[.9, .1], [.6, .4]];
                if (c.length)
                    return o = [l.outerHeight(!1), l.outerWidth(!1)],
                    a = [c[0].offsetTop + ee(l)[0], c[0].offsetLeft + ee(l)[1]],
                    r = [c.parent()[0].offsetHeight, c.parent()[0].offsetWidth],
                    a[0] - r[0] * (s = [o[0] < r[0] ? u[0] : u[1], o[1] < r[1] ? u[0] : u[1]])[0][0] < 0 && a[0] + o[0] - r[0] * s[0][1] >= 0 && a[1] - r[1] * s[1][0] < 0 && a[1] + o[1] - r[1] * s[1][1] >= 0
            }
            ,
